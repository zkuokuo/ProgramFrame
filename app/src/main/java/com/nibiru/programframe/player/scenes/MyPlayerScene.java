package com.nibiru.programframe.player.scenes;
...
import nibiru.player.playerFactory.IPlayer;
import nibiru.player.playerFactory.MyPlayerFactory;
import nibiru.player.playerFactory.MyPlayer_android;
import nibiru.player.playerFactory.MyPlayer_vlc;
import nibiru.player.utils.MediaManager;
...
public class MyPlayerScene extends XBaseScene implements MediaManager.OnMediaScanListener {
    ...
    private void initPlayer() {
        myXVLCMediaPlayer = MyPlayerFactory.produceVLCPlayer();
...
//            LogUtil.log("媒体库信息获取宽高分别是：width : " + videoWidth + "\nheight : " + videoHeight);
            scale_x = 16 / 9f;
            scale_y = 1;
            scale_z = 1;
