package com.nibiru.framelib.stateBar;
...
import com.nibiru.framelib.utils.FrameCalculateUtils;
...
public class StatueView implements IXActorEventListener {
    ...
    public void initStatusBar() {
        ...
        timeLabel.setCenterPosition(FrameCalculateUtils.transformCenterX(117, 800, 1440), FrameCalculateUtils.transformCenterY(25, 212 + fixY, 1080), StateConstants.CENTER_Z);
        timeLabel.setAlignment(XLabel.XAlign.Right);
        timeLabel.setArrangementMode(XLabel.XArrangementMode.SingleRowNotMove);
        timeLabel.setSize(FrameCalculateUtils.transformSize(117), FrameCalculateUtils.transformSize(25));
        timeLabel.setName("time_label");
        mScene.addActor(timeLabel);

        bluetoothImage = new XImage("mr_bluetooth_off.png");
        bluetoothImage.setCenterPosition(FrameCalculateUtils.transformCenterX(19, 933, 1440), FrameCalculateUtils.transformCenterY(25, 210 + fixY, 1080), StateConstants.CENTER_Z);
        bluetoothImage.setName("bluetooth");
        bluetoothImage.setEventListener(this);
        bluetoothImage.setSize(FrameCalculateUtils.transformSize(19), FrameCalculateUtils.transformSize(25));
        mScene.addActor(bluetoothImage);

        wifiImage = new XImage("mr_wifi_off.png");
        wifiImage.setCenterPosition(FrameCalculateUtils.transformCenterX(28, 967, 1440), FrameCalculateUtils.transformCenterY(20, 214 + fixY, 1080), StateConstants.CENTER_Z);
        wifiImage.setName("wifi");
        wifiImage.setEventListener(this);
        wifiImage.setSize(FrameCalculateUtils.transformSize(28), FrameCalculateUtils.transformSize(20));
        mScene.addActor(wifiImage);

        batteryImage = new XImage("kuang.png");
        batteryImage.setCenterPosition(FrameCalculateUtils.transformCenterX(50, 1011, 1440), FrameCalculateUtils.transformCenterY(21, 213 + fixY, 1080), StateConstants.CENTER_Z);
        batteryImage.setSize(FrameCalculateUtils.transformSize(50), FrameCalculateUtils.transformSize(21));
        ...
        batteryProgress.setCenterPosition(FrameCalculateUtils.transformCenterX(40, 1014, 1440), FrameCalculateUtils.transformCenterY(18, 215 + fixY, 1080), StateConstants.CENTER_Z + 0.0011f);
        batteryProgress.setSize(FrameCalculateUtils.transformSize(40), FrameCalculateUtils.transformSize(18));
        ...
        batteryLvLabel.setCenterPosition(FrameCalculateUtils.transformCenterX(50, 1070, 1440), FrameCalculateUtils.transformCenterY(25, 213 + fixY, 1080), StateConstants.CENTER_Z + 0.001f);
        batteryLvLabel.setSize(FrameCalculateUtils.transformSize(50), FrameCalculateUtils.transformSize(25));
        ...
        batteryPower.setCenterPosition(FrameCalculateUtils.transformCenterX(15, 998, 1440), FrameCalculateUtils.transformCenterY(20, 213 + fixY, 1080), StateConstants.CENTER_Z + 0.002f);
        batteryPower.setSize(FrameCalculateUtils.transformSize(15), FrameCalculateUtils.transformSize(20));
