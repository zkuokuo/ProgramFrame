...
import com.nibiru.framelib.utils.FrameConstants;
...
public class MyDialogTip implements IXActorEventListener {
    ...
    private void initDialog(String titlestr, String contentstr, String leftbtn, String rightbtn) {
        if (dialogbg == null) {
            ...
            dialogbg.setCenterPosition(TipsCalculateUtils.transformCenterX(401, 845), TipsCalculateUtils.transformCenterY(220, 435), FrameConstants.CENTER_Z + 0.1f);
