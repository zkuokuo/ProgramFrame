...
import com.nibiru.framelib.utilcode.constant.PermissionConstants;
...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(UtilsCode.getApp().getPackageName());
    }
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(UtilsCode.getApp(), permission);
    }
    ...
    public static void launchAppDetailsSettings() {
        ...
        intent.setData(Uri.parse("package:" + UtilsCode.getApp().getPackageName()));
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(UtilsCode.getApp());
    }
