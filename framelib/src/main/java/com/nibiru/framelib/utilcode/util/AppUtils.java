package com.nibiru.framelib.utilcode.util;
...
public final class AppUtils {
    ...
    public static void registerAppStatusChangedListener(@NonNull final Object obj,
                                                        @NonNull final UtilsCode.OnAppStatusChangedListener listener) {
        UtilsCode.getActivityLifecycle().addOnAppStatusChangedListener(obj, listener);
    }
    ...
    public static void unregisterAppStatusChangedListener(@NonNull final Object obj) {
        UtilsCode.getActivityLifecycle().removeOnAppStatusChangedListener(obj);
    }
    ...
    public static void installApp(final File file) {
        ...
        UtilsCode.getApp().startActivity(getInstallAppIntent(file, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        UtilsCode.getApp().startActivity(getUninstallAppIntent(packageName, true));
    }
    ...
    public static boolean isAppInstalled(@NonNull final String packageName) {
        PackageManager packageManager = UtilsCode.getApp().getPackageManager();
        try {
    ...
    public static boolean isAppDebug() {
        return isAppDebug(UtilsCode.getApp().getPackageName());
    }
    ...
    public static boolean isAppDebug(final String packageName) {
        if (isSpace(packageName)) return false;
        try {
            PackageManager pm = UtilsCode.getApp().getPackageManager();
    ...
    public static boolean isAppSystem() {
        return isAppSystem(UtilsCode.getApp().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        return UtilsCode.isAppForeground();
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
        UtilsCode.getApp().startActivity(getLaunchAppIntent(packageName, true));
    }
    ...
    public static void relaunchApp(final boolean isKillProcess) {
        PackageManager packageManager = UtilsCode.getApp().getPackageManager();
        Intent intent = packageManager.getLaunchIntentForPackage(UtilsCode.getApp().getPackageName());
        if (intent == null) return;
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        UtilsCode.getApp().startActivity(intent);
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(UtilsCode.getApp().getPackageName());
    }
    ...
    public static void launchAppDetailsSettings(final String packageName) {
        ...
        UtilsCode.getApp().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    public static void exitApp() {
        List<Activity> activityList = UtilsCode.getActivityList();
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(UtilsCode.getApp().getPackageName());
    }
    ...
    public static String getAppPackageName() {
        return UtilsCode.getApp().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(UtilsCode.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(UtilsCode.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(UtilsCode.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(UtilsCode.getApp().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(UtilsCode.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(UtilsCode.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA256() {
        return getAppSignatureSHA256(UtilsCode.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureMD5() {
        return getAppSignatureMD5(UtilsCode.getApp().getPackageName());
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(UtilsCode.getApp().getPackageName());
    }
    ...
    private static Intent getInstallAppIntent(final File file, final boolean isNewTask) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            String authority = UtilsCode.getApp().getPackageName() + ".utilcode.provider";
            data = FileProvider.getUriForFile(UtilsCode.getApp(), authority, file);
        }
    ...
    private static Intent getLaunchAppIntent(final String packageName, final boolean isNewTask) {
        Intent intent = UtilsCode.getApp().getPackageManager().getLaunchIntentForPackage(packageName);
    ...
    private static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) UtilsCode.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(UtilsCode.getApp().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) UtilsCode.getApp().getSystemService(Context.APP_OPS_SERVICE);
                //noinspection ConstantConditions
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) UtilsCode.getApp()
