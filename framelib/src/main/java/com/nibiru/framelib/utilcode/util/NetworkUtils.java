...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        UtilsCode.getApp().startActivity(
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) UtilsCode.getApp().getSystemService(Context.TELEPHONY_SERVICE);
...
//            }
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) UtilsCode.getApp().getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) UtilsCode.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) UtilsCode.getApp().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) return "";
